<template>
    <header class="header">
        <div v-if="category=='Scene'" class="w-100 h-100">
            <img class="w-100 h-100" src="../assets/images/sceneBg.jpg" alt="東海岸">
        </div>
        <div v-if="category=='Food'" class="w-100 h-100">
            <img class="w-100 h-100" src="../assets/images/foodBg.jpg" alt="珍珠奶茶">
        </div>
        
        <div v-if="category=='Activity'" class="w-100 h-100">
            <img class="w-100 h-100" src="../assets/images/activityBg.jpg" alt="藝術展覽">
        </div>
