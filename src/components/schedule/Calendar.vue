<template>
    <header class="d-flex">
        <v-date-picker class="me-5" v-model="dateRange" is-range />
        <div>
    ...
    <footer>
        <div class="scheduleIcon" data-bs-toggle="modal"  data-bs-target="#editScheduleModal" @click="checkSelectDays"></div>
        <p @click="checkSelectDays" data-bs-toggle="modal" data-bs-target="#editScheduleModal">建立行程表</p>
    </footer>
    <!-- <button data-bs-toggle="modal"  >建立行程表</button> -->
    <!-- Modal -->
