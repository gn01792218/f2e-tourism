      ...
      >
        <div class="modal-content">
          <div class="modal-header d-flex align-items-center">
            ...
            <h5 class="modal-title wheretoGo-title" id="exampleModalLabel">
              大冒險:請問，你要去哪裡?
            </h5>
            <button
              type="button"
          ...
          <div class="modal-body">
            ...
            <header class="itemName">
              <h1 v-show="recommendData.RestaurantName">
                {{ recommendData.RestaurantName }}
              </h1>
              <h1 v-show="recommendData.ScenicSpotName">
                {{ recommendData.ScenicSpotName }}
              </h1>
              <h1 v-show="recommendData.HotelName">
                {{ recommendData.HotelName }}
              </h1>
              <h1 v-show="recommendData.ActivityName">
                {{ recommendData.ActivityName }}
              </h1>
            </header>
            ...
            <p
              v-if="
                !recommendData.DescriptionDetail && !recommendData.Description
              "
            >
              作者很神秘，沒任何打字...
            </p>
            ...
            <img
              v-if="recommendData.Picture"
              :src="recommendData.Picture.PictureUrl1"
              :alt="recommendData.Picture.PictureDescription1"
            />
          ...
          <div class="modal-footer d-flex justify-content-around">
            ...
            <div>
              <div
                class="bigAdventureIcon"
                data-bs-dismiss="modal"
                @click="gotItemPage(recommendData)"
              ></div>
              <p>前往查看</p>
            </div>
          </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const recommendData = computed(() => {
      ...
      return store.state.RandomItem.randomItemList[0];
    });
